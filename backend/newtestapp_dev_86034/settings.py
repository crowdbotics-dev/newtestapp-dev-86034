"""
Django settings for newtestapp_dev_86034 project.
...
ROOT_URLCONF = 'newtestapp_dev_86034.urls'
...
WSGI_APPLICATION = 'newtestapp_dev_86034.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newtestapp_dev_86034 API",
    "DESCRIPTION": "API documentation for newtestapp_dev_86034 App",
    "VERSION": "v1",
}
